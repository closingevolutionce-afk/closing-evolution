  ...
  return (
    <section id="rejoindre" className="relative py-28">
      <Container>
        ...
        >
          <div className="pointer-events-none absolute left-1/2 top-0 h-[300px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-volt-gradient opacity-40 blur-[120px]" />
