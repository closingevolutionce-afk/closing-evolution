...
export default function Hero() {
  return (
    <section className="relative overflow-hidden pb-24 pt-40 lg:pb-32 lg:pt-48">
      ...
      <div className="pointer-events-none absolute left-1/2 top-[-10%] h-[560px] w-[900px] -translate-x-1/2 rounded-full bg-emerald/20 opacity-30 blur-[140px]" />
        ...
        <div className="grid items-center gap-16 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            ...
            <motion.h1
              ...
              className="mt-6 max-w-xl font-display text-4xl font-bold leading-[1.08] text-white sm:text-5xl lg:text-6xl"
            >
            ...
            >
              <div className="flex -space-x-3">
                {['#4ade80', '#86efac', '#22c55e', '#fbbf24'].map((color, i) => (
                  <span
                    key={i}
                    className="h-9 w-9 rounded-full border-2 border-ink ring-1 ring-white/10"
                    style={{ background: `linear-gradient(135deg, ${color}, #0f1419)` }}
                  />
                ))}
              </div>
