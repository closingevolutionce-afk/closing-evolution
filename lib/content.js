...
export const features = [
  {
    ...
    tag: 'IA temps réel',
    description:
      'Affronte un prospect émotionnel, analytique, résistant ou le boss final — les 4 profils de la méthode Cercle Élite Closing. L’IA garde une vraie personnalité du début à la fin et ne lâche rien facilement.',
    bullets: [
...
export const testimonials = [
  {
    quote:
      'J’ai fait plus de progrès en 3 semaines sur Cercle Élite Closing qu’en 6 mois d’appels réels. L’IA ne me laisse rien passer.',
    name: 'Yanis B.',
