...
import { citations } from '@/lib/interactive-content'
...
const encouragements = [
  ...
  'Là où tu vas mettre ton regard, tu vas te diriger.',
]

const messages = [...bangers, ...encouragements, ...citations.map((c) => c.texte)]
