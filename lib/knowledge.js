...
// Ordre plat des 20 modules, dans l'ordre des 3 niveaux — sert au déblocage séquentiel.
export const moduleOrder = levels.flatMap((level) => level.modules.map((m) => m.id))
