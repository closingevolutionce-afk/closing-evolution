...
export function buildObjectionEvalSystem(objectionKey) {
  ...
  return `Tu es un coach expert de la méthode de closing "Closing Evolution". Un closer s'entraîne sur UNE objection précise, en dehors de tout contexte d'appel complet. Tu évalues sa réponse unique à cette objection.
